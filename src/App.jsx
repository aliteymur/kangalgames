    ...
    <>
      ...
      <header className={`nav ${scrolled ? 'scrolled' : ''}`}>
        <div className="container nav-inner">
          ...
          <nav className={`nav-links ${menuOpen ? 'open' : ''}`}>
            ...
            <a href="#craft" onClick={close}>What we make</a>
            <a href="#demo" onClick={close}>Demo</a>
            <a href="#roadmap" onClick={close}>Roadmap</a>
            <a href="#contact" onClick={close} className="btn btn--primary" style={{color:"black"}}>Get in touch</a>
          </nav>
        </div>
      </header>
      ...
      <main id="top">
        <section className="hero">
          <div className="container hero-grid">
            <div>
              <span className="hero-badge reveal in"><span className="dot" /> Independent game studio · Málaga TechPark · Spain</span>
              <h1 className="reveal in">
                Loyal to the craft.<br />
                <span className="gradient-text">Fearless</span> in the making.
              </h1>
              <p className="sub reveal in d1">
                Kangal Games is a new independent studio building bold, high-craft
                games starting on mobile, with our sights set on AA and beyond.
                Named for the Anatolian Kangal: strong, loyal, unshakeable.
              </p>
              <div className="hero-cta reveal in d2">
                <a href="#craft" className="btn btn--primary">See what we’re building <Arrow /></a>
                <a href="#studio" className="btn btn--ghost">About the studio</a>
              </div>
              <div className="hero-stats reveal in d3">
                <div className="s"><b>2026</b><span>Founded</span></div>
                <div className="s"><b>Mobile-first</b><span>Debut title</span></div>
                <div className="s"><b>AA → AAA</b><span>The ambition</span></div>
              </div>
            </div>
        ...
        <section id="studio" className="section">
          <div className="container about-grid">
            <div className="reveal">
              ...
              <h2 className="section-title">A young studio with an old spirit.</h2>
              <p>
                Kangal Games takes its name from the <strong className="text-tan">Anatolian
                Kangal</strong> the guardian dog of the Turkish highlands, known
                for its loyalty, calm strength and refusal to back down. That’s the
                temperament we’re building the studio around.
              </p>
              <p>
                We’re independent and early. We don’t have a shipped game yet and
                we’re not going to pretend otherwise. What we have is a clear
                direction: make games with real craft, treat players with respect,
                and grow deliberately from mobile toward AA and, in time, AAA.
              </p>
            </div>
        ...
        <section id="craft" className="section">
          <div className="container">
            <div className="reveal">
              ...
              <h2 className="section-title">From your pocket to the big screen.</h2>
        ...
        <section id="roadmap" className="section">
          <div className="container">
            <div className="reveal">
              ...
              <p className="section-lead">Honest about today, clear about tomorrow.</p>
            </div>
            <div className="roadmap">
              <div className="road-line" aria-hidden="true" />
              {ROADMAP.map((r) => (
                <div key={r.n} className={`road-item reveal ${r.active ? 'active' : ''}`}>
        ...
        <section id="contact" className="section">
          <div className="container">
            <div className="cta reveal">
              <span className="eyebrow" style={{ justifyContent: 'center' }}>Join the pack</span>
              ...
              <div className="cta-actions">
                <a href="mailto:hello@kangalgames.com" className="btn btn--primary">hello@kangalgames.com</a>
                <a href="#studio" className="btn btn--ghost">Learn more</a>
              </div>
               {/*}
              <div className="socials">
                <a href="#" onClick={(e) => e.preventDefault()} aria-label="X / Twitter"><XIcon /></a>
                <a href="#" onClick={(e) => e.preventDefault()} aria-label="LinkedIn"><InIcon /></a>
                <a href="#" onClick={(e) => e.preventDefault()} aria-label="Discord"><DiscordIcon /></a>
                <a href="#" onClick={(e) => e.preventDefault()} aria-label="Instagram"><IgIcon /></a>
              </div>
               */}
            </div>
          </div>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          ...
          <span className="muted">© {new Date().getFullYear()} Kangal Games. All rights reserved.</span>
        </div>
      </footer>
    </>
  )
...
function StripItems() {
  const items = ['Independent studio', 'Mobile-first', 'AA craft', 'AAA ambition', 'Player-first', 'Made in Spain']
  return (
    <>
      {items.map((t, i) => (
...
const S = { width: 24, height: 24, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.7, strokeLinecap: 'round', strokeLinejoin: 'round' }
function Arrow() { return <svg {...S} width={18} height={18} style={{ color: 'inherit' }}><path d="M5 12h14M13 6l6 6-6 6" /></svg> }
function PhoneIcon() { return <svg {...S} style={{ color: 'var(--tan)' }}><rect x="7" y="2" width="10" height="20" rx="2.5" /><path d="M11 18h2" /></svg> }
function ConsoleIcon() { return <svg {...S} style={{ color: 'var(--tan)' }}><rect x="2" y="7" width="20" height="10" rx="5" /><path d="M7 11v2M6 12h2M15.5 11.5h.01M18 13.5h.01" /></svg> }
function StarIcon() { return <svg {...S} style={{ color: 'var(--tan)' }}><path d="M12 3l2.6 5.6 6 .8-4.4 4.2 1.1 6L12 17l-5.3 2.6 1.1-6L3.4 9.4l6-.8z" /></svg> }
function ShieldIcon() { return <svg {...S} style={{ color: 'var(--tan)' }}><path d="M12 3l7 3v6c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z" /><path d="M9 12l2 2 4-4" /></svg> }
function FlameIcon() { return <svg {...S} style={{ color: 'var(--tan)' }}><path d="M12 3c1 3-2 4-2 7a2 2 0 104 0c0-1 .5-1.5 1-2 1.5 2 2 3.5 2 5a5 5 0 11-10 0c0-4 3-6 5-10z" /></svg> }
function GemIcon() { return <svg {...S} style={{ color: 'var(--tan)' }}><path d="M6 4h12l3 5-9 11L3 9z" /><path d="M3 9h18M9 4l-3 5 6 11 6-11-3-5" /></svg> }
function HeartIcon() { return <svg {...S} style={{ color: 'var(--tan)' }}><path d="M12 20s-7-4.5-9-9a4.5 4.5 0 018-3 4.5 4.5 0 018 3c-2 4.5-9 9-9 9z" /></svg> }
function XIcon() { return <svg {...S} width={19} height={19}><path d="M4 4l16 16M20 4L4 20" /></svg> }
function InIcon() { return <svg {...S} width={19} height={19}><rect x="3" y="3" width="18" height="18" rx="3" /><path d="M7 10v7M7 7v.01M11 17v-4a2 2 0 014 0v4" /></svg> }
function DiscordIcon() { return <svg {...S} width={19} height={19}><path d="M7 8c3-1.5 7-1.5 10 0M7 16c3 1.5 7 1.5 10 0M8 9l-1.5 7M16 9l1.5 7" /><circle cx="9.5" cy="12" r="1" /><circle cx="14.5" cy="12" r="1" /></svg> }
function IgIcon() { return <svg {...S} width={19} height={19}><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><path d="M17 7v.01" /></svg> }
